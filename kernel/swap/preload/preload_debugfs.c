...
static struct dentry *target_list;
static struct dentry *target_add;
static struct dentry *target_remove;
static struct dentry *ignored_list;
static struct dentry *ignored_add;
static struct dentry *ignored_remove;
