...
#define NR_SUBPMIC_RT5033_IRQS	(25)
#else
#define NR_SUBPMIC_RT5033_IRQS	(0)
#endif
...
#define NR_IRQS				(__NR_IRQS + CONFIG_EIRQ_NUM + NR_SUBPMIC_RT5033_IRQS)
#else
#error 'Dont support CONFIG_EIRQ_NUM & CONFIG_SPARSE_IRQ coexist'
#endif /* CONFIG_SPARSE_IRQ */
#else
#define NR_IRQS				(NR_SCI_PHY_IRQS + NR_ANA_IRQS + NR_GPIO_IRQS + NR_SUBPMIC_RT5033_IRQS)
