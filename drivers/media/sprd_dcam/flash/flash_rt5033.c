...
uint32_t rt5033_flash_on(uint32_t flash_index) {
	struct flashlight_device* flash_ptr = NULL;
...
uint32_t rt5033_flash_high_light(uint32_t flash_index) {
	struct flashlight_device* flash_ptr = NULL;
	printk("%s: In. flash_index %d\n",__func__,flash_index);
...
uint32_t rt5033_flash_close(uint32_t flash_index) {
	struct flashlight_device* flash_ptr = NULL;
	printk("%s: In. flash_index %d\n",__func__,flash_index);
