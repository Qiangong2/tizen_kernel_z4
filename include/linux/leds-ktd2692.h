...
#define KTD2692_MAX_CURRENT_SUPPORT	1500	/* 1.5A */
#define KTD2692_EXT_RESISTOR		1500	/* 1.5 kohm Rset */
#define KTD2692_MAX_CURRENT ((KTD2692_MAX_CURRENT_SUPPORT / KTD2692_EXT_RESISTOR) * 1000) /* mA */
#define KTD2692_FLASH_DEFAULT_CURRENT	875	/* 875mA */
#define KTD2692_MOVIE_DEFAULT_CURRENT	104	/* 104mA */
